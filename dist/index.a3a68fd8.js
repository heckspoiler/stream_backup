...
})({"5ilvJ":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "5bcc22eca3a68fd8";
"use strict";
...
},{}],"svIyg":[function(require,module,exports) {
var _artistArrayJs = require("./artistArray.js");
...
switch(currentDay){
    case 5:
        artists = (0, _artistArrayJs.friday);
        break;
    case 6:
        artists = (0, _artistArrayJs.saturday);
        break;
    case 0:
        artists = (0, _artistArrayJs.sunday);
        break;
    default:
        artists = [];
}
...
const timeslotAutomation = ()=>{
    ...
    for(let i = 0; i < artists.length; i++){
        ...
        const [startTimeHour, startTimeMinute] = artist.startTime.split(":").map(Number);
        ...
        if (currentMinuteTotal >= startTimeMinuteTotal && currentMinuteTotal < endTimeMinuteTotal) {
    ...
    if (currentArtist) {
        currentArtistFields.forEach((field)=>field.innerHTML = `Now Playing: ${currentArtist.name}`);
        nextArtistField.innerHTML = nextArtist ? `Next Up: ${nextArtist.name}` : "No more artists today";
        reddots.forEach((reddot)=>{
            reddot.classList.add("reddot-active");
            reddot.classList.remove("reddot-inactive");
        });
    } else {
        currentArtistFields.forEach((field)=>field.innerHTML = "We're not live now");
...
const walidVideoShow = ()=>{
    ...
    if (currentDay === 6 && currentHour === 12) videoFrame.src = walidURL;
    else videoFrame.src = streamURL;
};
setTimeout(walidVideoShow, 3000);
setTimeout(timeslotAutomation, 3000);
setInterval(timeslotAutomation, 120000);

},{"./artistArray.js":"aMEV4"}]},["5ilvJ","svIyg"], "svIyg", "parcelRequiref297")

//# sourceMappingURL=index.a3a68fd8.js.map
