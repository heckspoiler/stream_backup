...
})({"jVi5r":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "f51f5ecdb442195b";
"use strict";
...
},{}],"5kOhY":[function(require,module,exports) {
...
const twintLandingContainer = document.querySelector(".container-twint-landing");
...
function copyTwintLanding(event) {
    ...
    navigator.clipboard.writeText(text).then(()=>{
        ...
        const twintLandingCopiedContainer = document.querySelector(".twint-landing-copied-container");
        const twintLandingCopied = document.querySelector(".twint-landing-copied");
        ...
        setTimeout(()=>{
            ...
            twintLandingCopiedContainer.classList.remove("copied-container-visible");
        }, 2000);
    }).catch((err)=>{
        console.error("Error in copying text: ", err);
    });
...
function copyIBANLanding(event) {
  ...
  SWIFT: ZKBKCHZZ80A`;
    navigator.clipboard.writeText(text).then(()=>{
        ...
        const ibanLandingCopiedContainer = document.querySelector(".iban-landing-copied-container");
...
},{}]},["jVi5r","5kOhY"], "5kOhY", "parcelRequiref297")

//# sourceMappingURL=index.b442195b.js.map
